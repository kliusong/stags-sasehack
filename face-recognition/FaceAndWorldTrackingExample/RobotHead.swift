...
class RobotHead: Entity, HasModel {
    ...
    private let notTrackedheadColor: SimpleMaterial.Color = .red
    ...
    var appearance: Appearance = .notTracked {
        didSet {
            ...
            case .notTracked:
                headEntity.color = notTrackedheadColor
            ...
            //Ryan screws with things; switching default and switch cases to fit our needs more appropriately
            */
    ...
    func update(with faceAnchor: ARFaceAnchor) {
        ...
        //
        //CONNOR and RYAN fuck things over part 2
        //changed -faceTransformFromcamera.columns.3.z to +, in an attempt to make movement more realistic for our purposes
        //
        //
